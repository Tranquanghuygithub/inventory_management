                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <form:form modelAttribute="searchForm"  cssClass="form-horizontal form-label-left" 
                    	servletRelativeAction="/category/list/1" method="POST" accept-charset="ISO-8859-1">
					...
					<div class="container">
						<a class="btn btn-app" href="<c:url value = "/category/add"/>"><i class="fa fa-plus"></i>Add Category</a>
					</div>
                  <div class="x_content">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <c:forEach items="${categories }" var="category" varStatus="loop">
	                        <c:choose>
	                            ...
	                            <td class="a-right a-right ">${category.description }</td>
	                            <td class="text-center last"><a href="<c:url value="/category/view/${category.id }"/>" class="btn btn-info btn-sm">View</a></td>
	                            <td class="text-center last"><a href="<c:url value="/category/edit/${category.id }"/>" class="btn btn-warning btn-sm">Edit</a></td>
	                            <td class="text-center last"><a href="javascript:void(0);" onclick="confirmDeleteCategory(${category.id});" class="btn btn-danger btn-sm">Delete</a></td>
	                          </tr>
	                        </c:forEach>
                        </tbody>
                      </table>
