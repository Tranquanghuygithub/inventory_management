                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <form:form modelAttribute="searchForm"  cssClass="form-horizontal form-label-left" 
                    	servletRelativeAction="/goods-receipt/list/1" method="POST" accept-charset="ISO-8859-1">
					...
					<div class="container">
						<a class="btn btn-app" href="<c:url value = "/goods-receipt/add"/>"><i class="fa fa-plus"></i>Add Invoice</a>
						<a href="<c:url value ="/goods-receipt/export"/>"><i class="fa fa-cloud-download"></i> Export to Excel</a>
					</div>
                  <div class="x_content">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <c:forEach items="${invoices }" var="invoice" varStatus="loop">
	                        <c:choose>
	                            ...
	                            <td class="text-center last"><a href="<c:url value="/goods-receipt/view/${invoice.id }"/>" class="btn btn-info btn-sm">View</a></td>
	                            <td class="text-center last"><a href="<c:url value="/goods-receipt/edit/${invoice.id }"/>" class="btn btn-warning btn-sm">Edit</a></td>
